...
function Services() {
  let cardOne = {
    ...
    facilityOneContent:
      "Tailored advice and support for each country’s visa requirements.",
    facilityTwo: "Document Preparation",
    facilityTwoContent:
      "Assistance with gathering, completing, and verifying all necessary documents.",
    facilityThree: "Application Submission",
    facilityThreeContent:
  ...
  let cardTwo = {
    ...
    facilityOneContent:
      "Assistance with visa fees, travel costs, and other related expenses.",
    facilityTwo: "Flexible Repayment",
    facilityTwoContent:
      "Repay your loan under agreed conditions once you start earning abroad.",
  ...
  let cardThree = {
    ...
    facilityOneContent:
      "Identify the best opportunities that match your skills and goals.",
    facilityTwo: "Pre-Departure Orientation",
    facilityTwoContent:
      "Learn about the culture, work environment, and living conditions in your new country.",
    facilityThree: "Ongoing Support",
    facilityThreeContent:
      "Continuous assistance until you are fully settled in your new role.",
  };
  ...
  let cardFour = {
    ...
    facilityOneContent:
      "Opportunities for Nurses and Carers in various care homes across the UK.",
    facilityTwo: "Comprehensive Matching",
    facilityTwoContent:
      "We align your qualifications with the right position to ensure job satisfaction.",
    facilityThree: "Continuous Support",
    facilityThreeContent:
      "From job placement to contract negotiation and beyond.",
  };
