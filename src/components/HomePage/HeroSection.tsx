...
function HeroSection() {
  return (
    <div className="">
      ...
      <div className="w-full h-[200px] md:h-[150px] xl:h-[250px] mt-[160px] xl:mt-0 flex justify-center">
        <div className="translate-y-[-50%] w-[300px] h-[490px] xl:w-[972px] xl:h-[422px] bg-white shadow-2xl rounded-[15px] flex flex-col items-center">
          <h2 className="font-[700] text-[35px] text-center   xl:text-[40px] text-[#21215F] xl:mt-[45px]">
            Welcome to Randiv Work Force
          </h2>
          <p className="xl:w-[734px] pl-5 pr-5 xl:pl-0 xl:pr-0 mt-[20px]  xl:h-[192px] xl:text-[22px] font-[400] xl:mt-[50px]">
